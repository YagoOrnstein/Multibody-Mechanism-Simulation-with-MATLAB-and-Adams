! AVIEW_SETTINGS_90 : aviewBS.cmd : 2025/01/18,13:09:14
!
...
view manage modify &
   ...
   triad=on &
   name=on
int grid display grid=.gui.grid view=( db_default( .system_defaults, "view" )) 
...
simulation multi_run set opt_algorithm=mscads_mmfd
...
default plt_attributes legend_font_size=9
default plt_attributes date_note_font_size=9
default plt_attributes subtitle_font_size=9
default plt_attributes title_font_size=9
default plt_attributes table_font_size=9
default plotting axis_numbers_font_size=9
default plotting axis_label_font_size=9
default report base_font_size=10
!
!-------------------------------------------
